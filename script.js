...
function DibujarPregunta(p, i) {
    let datos = "<div>";
    datos = `<h3>Question ` + (i+1) + " - " + `${p}</h3></div>`
...
function DibujarRespuestas(i2, c, r) {
    let datos2 = "<div>";
    datos2 += `<input type="radio" name="${i2}" value="${c}"/>${r[0]}<br>
                            <input type="radio" name="${i2}" value="${c}"/>${r[1]}<br>
                            <input type="radio" name="${i2}" value="${c}"/>${r[2]}<br>
                            <input type="radio" name="${i2}" value="${c}"/>${r[3]}<br></div>`
